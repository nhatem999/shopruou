<div id="header-wp">
    ...
    <div id="head-body" class="clearfix">
        <div class="wp-inner">
            <a href="{{ route('user.index') }}" title="" id="logo" class="fl-left">
                {{-- <img
                    src="{{ asset('public/users/images/logo.png') }}" /> --}}
                    <p style="font-size: 22px;
                    font-family: fangsong;
                    font-style: italic;
                    text-align: center;
                    margin-top: 10px;">SHOPRUOU24h</p>
            </a>
            ...
            <div id="action-wp" class="fl-right">
                <div id="advisory-wp" class="fl-left">
                    ...
                    <span class="phone">0784.568.161</span>
                </div>
