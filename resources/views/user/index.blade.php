...
@section('content')
    <div class="main-content fl-right">
                        ...
                        <li>
                            ...
                            <div class="action clearfix">
                                <a href="{{ route('cart.addProduct', ['id' => $item->id]) }}" title=""
                                    ...
                                    giỏ hàng</a>
                                <a href="{{ route('cart.buy', ['id' => $item->id]) }}" title=""
        ...
        <div class="section" id="list-product-wp">
            <div class="section-head">
                <a href="{{ route('user.category', ['slugCategory' => 'ruou-tet-ruou-bieu-tang-tet']) }}"
                    class="section-title">Rượu tết / Rượu biếu tặng tết</a>
            </div>
            <div class="section-detail">
                <ul class="list-item clearfix">
                    @foreach ($productRuouTet as $item)
                        <li>
                            <a href="{{ route('product.detail', ['slugCategory' => $item->category->catProductParent->slug, 'slugProduct' => $item->slug]) }}"
                                title="" class="thumb">
                                <div class="height-thumb" style="height:250px">
                                    <img src="{{ asset($item->feature_image) }}">
                                </div>
        ...
        {{-- end --}}
        {{-- Rượu vang Rượu Vang Pháp / Bordeaux / Chateau --}}
        <div class="section" id="list-product-wp">
            <div class="section-head">
                <a href="{{ route('user.category', ['slugCategory' => 'ruou-vang-phap-bordeaux-chateau']) }}"
                    class="section-title">Rượu Vang Pháp / Bordeaux / Chateau</a>
            </div>
            <div class="section-detail">
                <ul class="list-item clearfix">
                    @foreach ($productRuouPhap as $item)
                        <li>
                            <a href="{{ route('product.detail', ['slugCategory' => $item->category->catProductParent->slug, 'slugProduct' => $item->slug]) }}"
                                title="" class="thumb">
                                <div class="height-thumb" style="height:250px">
        ...
        <div class="section" id="list-product-wp">
            <div class="section-head">
                <a href="{{ route('user.category', ['slugCategory' => 'ruou-vodka']) }}"
                    class="section-title">RƯỢU VIỆT NAM - VODKA</a>
            </div>
            <div class="section-detail">
                <ul class="list-item clearfix">
                    @foreach ($productRuouVodka as $item)
                        <li>
                            <a href="{{ route('product.detail', ['slugCategory' => $item->category->catProductParent->slug, 'slugProduct' => $item->slug]) }}"
                                title="" class="thumb">
                                <div class="height-thumb" style="height:250px">
